				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown messages-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <span class="label label-success"></span>
						</a>
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					<div class="pull-left image">
						<img src="${vo.photo }" class="img-circle" alt="User Image" />
					</div>
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview"><a href="#"> <i
							class="fa fa-dashboard"></i> <span>모드 변경(운전자or이용자)</span> <i
							class="fa fa-angle-left pull-right"></i>
					</a>
						<ul class="treeview-menu">
							<li><a id="use"><i class="fa fa-circle-o"></i><span
									id="forb">탈래요 모드</span></a></li>
