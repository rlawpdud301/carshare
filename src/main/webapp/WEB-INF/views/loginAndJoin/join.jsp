...
<script>
var i = 0;
var txt1 = "안녕 하세요. +${vo.nickname} 님 만나서 반갑습니다. +저는 GET입니다. +${vo.nickname} 님의 안전한 GET 이용을위하여 개인정보 수집이 필요합니다. 계속하시겠습니까?";
var speed = 70;    
...
function Greetings(){   	 
  ...
  $(function () {
    ...
    $(document).on("click","#ok4",function(){
    	...
    	if(!regemail.test($("#emailbefor").val()))	{
       	   $("#greetings").empty();
    ...
    $(document).on("click","#add",function(){
    	...
    	textbnt = "<br><button type='button' id='add'>네! 소개할께요!</button><br><button type='button' id='cancel'>아니요. 나중에 할께요!</button>";
